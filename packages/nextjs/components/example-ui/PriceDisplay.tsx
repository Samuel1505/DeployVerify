...
export const PriceDisplay = ({ symbol }: PriceDisplayProps) => {
  ...
  // Wrap fetchPrice in useCallback with all dependencies
  ...
  }, [deployedContractData, symbol]); // Add both dependencies here
  ...
  }, [fetchPrice]); // Now fetchPrice is properly memoized
